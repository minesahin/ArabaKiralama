...
public class ArabaProje {
    ...
    ***********  Araba Kiralama Projesi TASK   ***********
        ...
        -	aracTalep() adında bir method oluşturunuz.        Bu method’da alinacak sehir,
        *  teslim edilecek sehir, alinacak gun ve teslim edilecek gun ve teslim saati bilgilerini aliniz.
        ...
        *  (parametre olarak araç ile bilgileri alan <marka, model, yakıt tipi, vites, gunlukUcret> objeleri list’e atınız.)        Bu list’i göstererek bir aracı kiralamasını sağlayın.
